...
const RESULT_CONTENT = {
  "zh-TW": {
    red: {
      ...
      pureView: [
        "紅馳視角會先看作品能否被看見、被討論，並持續累積影響力。",
        "你通常把創作、讀者經營、平台策略視為同一個長期工程。",
      ],
      hybrids: {
        green: ["若同分或次高是綠躍，你會更擅長把創意變成可傳播的企劃。"],
        blue: ["若同分或次高是藍行，你的商業判斷會有更強的結構支撐。"],
        black: ["若同分或次高是墨佇，你更容易在文學質地與受眾接受度間取得平衡。"],
        white: ["若同分或次高是銀倚，角色魅力與市場策略會形成高黏著讀者群。"],
      },
    },
    green: {
      main: [
      ...
      pureView: [
        "綠躍視角最在意新意與趣味，對過度套路化內容耐受度較低。",
        "你通常會先追求好玩，再回頭處理收束與完稿節奏。",
      ],
      hybrids: {
        red: ["若同分或次高是紅馳，你更容易把新奇概念落地成可行方案。"],
        blue: ["若同分或次高是藍行，你的高概念作品會更有邏輯與可讀性。"],
        black: ["若同分或次高是墨佇，語言表現力會進一步放大你的創意辨識度。"],
        white: ["若同分或次高是銀倚，角色厚度會讓你的創意更有情感感染力。"],
      },
    },
    blue: {
      main: [
      ...
      pureView: [
        ...
        "你通常會先檢查合理性與結構完整，再判斷情感與創意是否成立。",
      ],
      hybrids: {
        red: ["若同分或次高是紅馳，嚴謹結構會更容易轉化成長線 IP 企劃。"],
        green: ["若同分或次高是綠躍，你能把跳躍點子變成可運作的完整世界。"],
        black: ["若同分或次高是墨佇，作品會同時具備思想深度與邏輯說服力。"],
        white: ["若同分或次高是銀倚，角色行為與心理動機通常會更完整可信。"],
      },
    },
    black: {
      main: [
      ...
      hybrids: {
        red: ["若同分或次高是紅馳，文學深度能與市場擴散力並行。"],
        green: ["若同分或次高是綠躍，創意與文筆會疊出更鮮明的個人風格。"],
        blue: ["若同分或次高是藍行，詩意表達會有更穩固的結構支撐。"],
        white: ["若同分或次高是銀倚，角色心理與文本質地會形成更強的情感滲透力。"],
      },
    },
    white: {
      main: [
      ...
      pureView: [
        ...
        "你通常對多數題材都開放，只要人物可信、情感能成立。",
      ],
      hybrids: {
        red: ["若同分或次高是紅馳，角色魅力會更容易轉化為穩定的讀者黏著。"],
        green: ["若同分或次高是綠躍，不按牌理的人物設定會成為作品記憶點。"],
        blue: ["若同分或次高是藍行，角色成長弧線通常會更扎實且可信。"],
        black: ["若同分或次高是墨佇，文學表現力會放大角色內心層次與情感密度。"],
      },
    },
  },
  en: {
