...
const RESULT_CONTENT = {
  "zh-TW": {
    red: {
      main: [
        "你重視作品的市場價值與長期傳播力，會主動思考題材是否具有可擴張性與受眾黏著度。",
        "你擅長觀察讀者反應與市場走向，能把創作熱情轉成可持續的內容策略。",
        "你的核心優勢在於執行力與經營力，但也要避免長期高壓導致創作疲乏。",
      ],
      pureView: [
        "紅馳視角重視作品被看見、被記住、被持續討論的能力。",
        "你通常不排斥跨平台延伸與社群互動，並把這些視為創作的一部分。",
      ],
      hybrids: {
    ...
    green: {
      main: [
        "你將創意視為作品的核心驅動，偏好不按常規、具辨識度的敘事路線。",
        "你善於提出新鮮設定與意外轉折，常能帶出強烈的個人風格。",
        "你的優勢是點子密度高，挑戰是如何穩定完稿與維持敘事收束。",
      ],
      pureView: [
        "綠躍視角重視有趣與新意，對套路化敘事耐受度較低。",
        "你通常願意嘗試不同文本形態，但需要節奏管理避免概念先行。",
      ],
      hybrids: {
    ...
    blue: {
      main: [
        "你高度重視邏輯與可信度，習慣先建立結構再推進敘事。",
        "你會投入大量考據與設定設計，確保作品在細節上站得住腳。",
        "你的優勢是內在一致性強，挑戰是避免過度解釋拖慢節奏。",
      ],
      pureView: [
        "藍行視角偏好有脈絡、有推理、有細節支撐的文本。",
        "你欣賞創意與情感，但通常會先檢查其合理性與結構完整。",
      ],
      hybrids: {
    ...
    black: {
      main: [
        "你重視文字質地與文學表現，語言本身就是你創作的主戰場。",
        "你常透過修辭、節奏與隱喻建立情感深度與思想張力。",
        "你的優勢是文本餘韻與主題厚度，挑戰是兼顧普遍可讀性。",
      ],
      pureView: [
        "墨佇視角重視作品想說什麼，以及如何說得精確而有韻味。",
        "你通常在意篇章層次與語感一致，對粗糙表述容忍度低。",
      ],
      hybrids: {
    ...
    white: {
      main: [
        "你以角色與情感動力為核心，擅長描寫人物心理與關係張力。",
        "你常讓劇情從人物選擇自然生長，讀者容易對角色產生投入。",
        "你的優勢是人性描寫真實，挑戰是維持整體結構與世界層次。",
      ],
      pureView: [
        "銀倚視角強調角色完整度，重視情緒變化的因果與細節。",
        "你通常對各類風格都開放，只要角色可信、情感成立。",
      ],
      hybrids: {
